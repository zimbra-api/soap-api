 ...
 */
class MailCalDataSourceTest extends ZimbraTestCase
{
    public function testMailCalDataSource()
    {
        ...
        $this->assertTrue($cal instanceof MailDataSource);
...
EOT;
        ...
        $this->assertEquals($cal, $this->serializer->deserialize($xml, StubMailCalDataSource::class, 'xml'));
    }
}

#[XmlNamespace(uri: 'urn:zimbraMail', prefix: 'urn')]
class StubMailCalDataSource extends MailCalDataSource
{
}
