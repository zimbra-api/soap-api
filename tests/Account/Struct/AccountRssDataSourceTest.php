 ...
 */
class AccountRssDataSourceTest extends ZimbraTestCase
{
    public function testAccountRssDataSource()
    {
        ...
        $rss = new MockAccountRssDataSource(
...
EOT;
        ...
        $this->assertEquals($rss, $this->serializer->deserialize($xml, MockAccountRssDataSource::class, 'xml'));
    }
}
 ...
 */
class MockAccountRssDataSource extends AccountRssDataSource
{
}
