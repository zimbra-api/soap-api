...
class SaveDraftBody extends SoapBody
{
    ...
    #[SerializedName(name: 'SaveDraftRequest')]
    #[Type(name: SaveDraftRequest::class)]
     ...
     * @param  SaveDraftResponse $response
     * @return self
     */
    ...
    {
        if ($request instanceof SaveDraftRequest) {
    ...
    {
        if ($response instanceof SaveDraftResponse) {
