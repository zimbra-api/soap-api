...
use Zimbra\Admin\Message\ModifyFilterRulesBody;
use Zimbra\Admin\Message\ModifyFilterRulesEnvelope;
use Zimbra\Admin\Message\ModifyFilterRulesRequest;
use Zimbra\Admin\Message\ModifyFilterRulesResponse;
...
/**
 * Testcase class for ModifyFilterRulesTest.
 */
class ModifyFilterRulesTest extends ZimbraStructTestCase
{
    ...
    public function testModifyFilterRules()
    {
        ...
        $request = new ModifyFilterRulesRequest($type, $account, $domain, $cos, $server, [$filterRule]);
        ...
        $response = new ModifyFilterRulesResponse();

        $body = new ModifyFilterRulesBody($request, $response);
        $this->assertSame($request, $body->getRequest());
        $this->assertSame($response, $body->getResponse());
        $body = new ModifyFilterRulesBody();
        $body->setRequest($request)
             ->setResponse($response);
        $this->assertSame($request, $body->getRequest());
        $this->assertSame($response, $body->getResponse());

        $envelope = new ModifyFilterRulesEnvelope($body);
        $this->assertSame($body, $envelope->getBody());
        $envelope = new ModifyFilterRulesEnvelope();
...
<soap:Envelope xmlns:soap="http://www.w3.org/2003/05/soap-envelope" xmlns:urn="urn:zimbraAdmin">
    <soap:Body>
        <urn:ModifyFilterRulesRequest type="$type">
        ...
        </urn:ModifyFilterRulesRequest>
        <urn:ModifyFilterRulesResponse />
    </soap:Body>
</soap:Envelope>
EOT;
        $this->assertXmlStringEqualsXmlString($xml, $this->serializer->serialize($envelope, 'xml'));
        $this->assertEquals($envelope, $this->serializer->deserialize($xml, ModifyFilterRulesEnvelope::class, 'xml'));
        ...
        $this->assertEquals($envelope, $this->serializer->deserialize($json, ModifyFilterRulesEnvelope::class, 'json'));
    }
}
