...
EOT;
        ...
        $this->assertJsonStringEqualsJsonString($json, $this->serializer->serialize($filterRule, 'json'));
        $this->assertEquals($filterRule, $this->serializer->deserialize($json, FilterRule::class, 'json'));
    }
}
