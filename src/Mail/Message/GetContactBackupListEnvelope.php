 ...
 */
class GetContactBackupListEnvelope extends Envelope
{
    /**
    ...
    /**
     * Constructor method for GetContactBackupListEnvelope
     *
     * @return self
     */
    public function __construct(?GetContactBackupListBody $body = NULL, ?Header $header = NULL)
    {
