 ...
 */
class GetServerStatsBody extends SoapBody
{
    /**
     ...
     */
    #[Accessor(getter: 'getRequest', setter: 'setRequest')]
    #[SerializedName(name: 'GetServerStatsRequest')]
    #[Type(name: GetServerStatsRequest::class)]
    #[XmlElement(namespace: 'urn:zimbraAdmin')]
    private $request;
     ...
     */
    #[Accessor(getter: 'getResponse', setter: 'setResponse')]
    #[SerializedName(name: 'GetServerStatsResponse')]
    #[Type(name: GetServerStatsResponse::class)]
    #[XmlElement(namespace: 'urn:zimbraAdmin')]
    private $response;
     ...
     * Constructor
     *
     * @param GetServerStatsRequest $request
     * @param GetServerStatsResponse $response
     * @return self
     */
