...
/**
 * CheckHostnameResolveEnvelope class
 * 
 * @package    Zimbra
 * @subpackage Admin
 * @category   Message
 ...
 */
class CheckHostnameResolveEnvelope extends Envelope
{
    /**
     ...
     * @return self
     */
    public function __construct(Header $header = NULL, CheckHostnameResolveBody $body = NULL)
    {
    ...
    {
        if ($body instanceof CheckHostnameResolveBody) {
            $this->body = $body;
        }
        return $this;
    }
