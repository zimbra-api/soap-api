 ...
 */
class ReloadMemcachedClientConfigBody extends SoapBody
{
    /**
     * @var ReloadMemcachedClientConfigRequest
     */
    #[Accessor(getter: 'getRequest', setter: 'setRequest')]
    #[SerializedName(name: 'ReloadMemcachedClientConfigRequest')]
    #[Type(name: ReloadMemcachedClientConfigRequest::class)]
     ...
     * Constructor
     *
     * @param ReloadMemcachedClientConfigRequest $request
     * @param ReloadMemcachedClientConfigResponse $response
     * @return self
     */
