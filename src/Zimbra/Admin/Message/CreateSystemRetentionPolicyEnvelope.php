 ...
 * @XmlNamespace(uri="urn:zimbraMail", prefix="mail")
...
class CreateSystemRetentionPolicyEnvelope extends Envelope
{
     ...
     * @SerializedName("Body")
     * @Type("Zimbra\Admin\Message\CreateSystemRetentionPolicyBody")
     * @XmlElement(namespace="http://www.w3.org/2003/05/soap-envelope")
     */
    private $body;

    /**
     * Constructor method for CreateSystemRetentionPolicyEnvelope
     * @return self
     */
    public function __construct(CreateSystemRetentionPolicyBody $body = NULL, Header $header = NULL)
    {
