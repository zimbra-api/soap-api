...
class SendDeliveryReportBody extends SoapBody
{
     ...
     * Constructor
     *
     * @param  SendDeliveryReportRequest $request
     * @param  SendDeliveryReportResponse $response
     * @return self
     */
    public function __construct(
        ?SendDeliveryReportRequest $request = null,
        ?SendDeliveryReportResponse $response = null
    ) {
