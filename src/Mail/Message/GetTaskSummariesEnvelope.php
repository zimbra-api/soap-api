...
class GetTaskSummariesEnvelope extends SoapEnvelope
{
    ...
    #[Accessor(getter: 'getBody', setter: 'setBody')]
    #[SerializedName('Body')]
    #[Type(GetTaskSummariesBody::class)]
    #[XmlElement(namespace: 'http://www.w3.org/2003/05/soap-envelope')]
    private $body;
     ...
     * Constructor
     *
     * @param  GetTaskSummariesBody $body
     * @param  SoapHeaderInterface $header
     * @return self
     */
    public function __construct(?GetTaskSummariesBody $body = NULL, ?SoapHeaderInterface $header = NULL)
    {
