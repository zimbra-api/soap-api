...
class SendShareNotificationBody extends SoapBody
{
     ...
     * Constructor
     *
     * @param  SendShareNotificationRequest $request
     * @param  SendShareNotificationResponse $response
     * @return self
     */
    public function __construct(
        ?SendShareNotificationRequest $request = NULL, ?SendShareNotificationResponse $response = NULL
    )
    {
