 ...
 * @XmlRoot(name="Body")
 */
class GetAllAccountLoggersBody extends Body
{
    /**
     ...
     * @return self
     */
    public function __construct(GetAllAccountLoggersRequest $request = NULL, GetAllAccountLoggersResponse $response = NULL)
    {
