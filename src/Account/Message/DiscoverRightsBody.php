...
class DiscoverRightsBody extends SoapBody
{
     ...
     */
    #[Accessor(getter: 'getRequest', setter: 'setRequest')]
    #[SerializedName(name: 'DiscoverRightsRequest')]
    #[Type(name: DiscoverRightsRequest::class)]
    #[XmlElement(namespace: 'urn:zimbraAccount')]
    private $request;
     ...
     */
    #[Accessor(getter: 'getResponse', setter: 'setResponse')]
    #[SerializedName(name: 'DiscoverRightsResponse')]
    #[Type(name: DiscoverRightsResponse::class)]
    #[XmlElement(namespace: 'urn:zimbraAccount')]
    private $response;
     ...
     * Constructor
     *
     * @param  DiscoverRightsRequest $request
     * @param  DiscoverRightsResponse $response
     * @return self
     */
