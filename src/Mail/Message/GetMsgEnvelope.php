 ...
 */
class GetMsgEnvelope extends Envelope
{
    /**
     * @Accessor(getter="getBody", setter="setBody")
     * @SerializedName("Body")
     * @Type("Zimbra\Mail\Message\GetMsgBody")
     * @XmlElement(namespace="http://www.w3.org/2003/05/soap-envelope")
     */
    private ?BodyInterface $body = NULL;

    /**
     * Constructor method for GetMsgEnvelope
     *
     * @return self
     */
    public function __construct(?GetMsgBody $body = NULL, ?Header $header = NULL)
    {
