...
/**
 * ComputeAggregateQuotaUsageEnvelope class
 * 
 * @package    Zimbra
 * @subpackage Admin
 * @category   Message
 ...
 */
class ComputeAggregateQuotaUsageEnvelope extends Envelope
{
    /**
     ...
     * @return self
     */
    public function __construct(Header $header = NULL, ComputeAggregateQuotaUsageBody $body = NULL)
    {
    ...
    {
        if ($body instanceof ComputeAggregateQuotaUsageBody) {
            $this->body = $body;
        }
        return $this;
    }
