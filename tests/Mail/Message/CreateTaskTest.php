...
use Zimbra\Mail\Message\CreateTaskEnvelope;
use Zimbra\Mail\Message\CreateTaskBody;
use Zimbra\Mail\Message\CreateTaskRequest;
use Zimbra\Mail\Message\CreateTaskResponse;
 ...
 */
class CreateTaskTest extends ZimbraTestCase
{
    public function testCreateTask()
    {
        ...
        $request = new CreateTaskRequest($msg, TRUE, $maxSize, TRUE, TRUE, TRUE);
        ...
        $body = new CreateTaskBody($request, $response);
        ...
        $envelope = new CreateTaskEnvelope($body);
        $this->assertSame($body, $envelope->getBody());
        $envelope = new CreateTaskEnvelope();
...
<soap:Envelope xmlns:soap="http://www.w3.org/2003/05/soap-envelope" xmlns:urn="urn:zimbraMail">
    <soap:Body>
        <urn:CreateTaskRequest echo="true" max="$maxSize" want="true" neuter="true" forcesend="true">
...
EOT;
        ...
        $this->assertEquals($envelope, $this->serializer->deserialize($xml, CreateTaskEnvelope::class, 'xml'));
        ...
        $this->assertEquals($envelope, $this->serializer->deserialize($json, CreateTaskEnvelope::class, 'json'));
    }
}
