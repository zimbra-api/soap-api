 ...
 */
class CheckDirectoryEnvelope extends Envelope
{
    /**
     * @Accessor(getter="getBody", setter="setBody")
     * @SerializedName("Body")
     * @Type("Zimbra\Admin\Message\CheckDirectoryBody")
     ...
     * @return self
     */
    public function __construct(Header $header = NULL, CheckDirectoryBody $body = NULL)
    {
    ...
    {
        if ($body instanceof CheckDirectoryBody) {
            $this->body = $body;
        }
        return $this;
    }
