 ...
 */
class GetAccountDistributionListsEnvelope extends Envelope
{
    /**
    ...
    /**
     * Constructor method for GetAccountDistributionListsEnvelope
     *
     * @return self
     */
    public function __construct(?GetAccountDistributionListsBody $body = NULL, ?Header $header = NULL)
    {
