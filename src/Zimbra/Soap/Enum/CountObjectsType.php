...
/**
 * CountObjectsType class
 * @package   Zimbra
 * @category  Soap
 * @author    Nguyen Van Nguyen - nguyennv1981@gmail.com
 * @copyright Copyright © 2013 by Nguyen Van Nguyen.
 */
class CountObjectsType
{
    /**
    ...
    public static function isValid($type)
    {
        $validValues = array(
            ...
            self::SERVER,
            self::CALRESOURCE,
            self::ACCOUNT_ON_UCSERVICE,
            self::COS_ON_UCSERVICE,
            self::DOMAIN_ON_UCSERVICE,
            self::INTERNAL_USER_ACCOUNT,
            self::INTERNAL_ARCHIVING_ACCOUNT,
        );
