...
class ClearCookieBody extends SoapBody
{
    ...
    #[SerializedName(name: 'ClearCookieResponse')]
    #[Type(name: ClearCookieResponse::class)]
    #[XmlElement(namespace: 'urn:zimbraAdmin')]
    private $response;
     ...
     * Constructor
     *
     * @param ClearCookieRequest $request
    ...
    {
        if ($request instanceof ClearCookieRequest) {
    ...
    {
        if ($response instanceof ClearCookieResponse) {
