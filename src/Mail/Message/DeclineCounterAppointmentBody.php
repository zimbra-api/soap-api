...
class DeclineCounterAppointmentBody extends SoapBody
{
    ...
    #[SerializedName(name: 'DeclineCounterAppointmentResponse')]
    #[Type(name: DeclineCounterAppointmentResponse::class)]
    #[XmlElement(namespace: 'urn:zimbraMail')]
    private $response;
     ...
     * Constructor
     *
     * @param  DeclineCounterAppointmentRequest $request
     * @param  DeclineCounterAppointmentResponse $response
     * @return self
     */
