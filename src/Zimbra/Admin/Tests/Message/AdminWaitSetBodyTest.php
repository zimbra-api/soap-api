...
use Zimbra\Admin\Message\{AdminWaitSetBody, AdminWaitSetRequest, AdminWaitSetResponse};
...
/**
 * Testcase class for AdminWaitSetBody.
 */
class AdminWaitSetBodyTest extends ZimbraStructTestCase
{
