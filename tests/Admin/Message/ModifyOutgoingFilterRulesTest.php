...
use Zimbra\Admin\Message\ModifyOutgoingFilterRulesBody;
use Zimbra\Admin\Message\ModifyOutgoingFilterRulesEnvelope;
use Zimbra\Admin\Message\ModifyOutgoingFilterRulesRequest;
use Zimbra\Admin\Message\ModifyOutgoingFilterRulesResponse;
...
class ModifyOutgoingFilterRulesTest extends ZimbraTestCase
{
    ...
    public function testModifyOutgoingFilterRules()
    {
        ...
        $request = new ModifyOutgoingFilterRulesRequest($type, $account, $domain, $cos, $server, [$filterRule]);
        ...
        $request = new ModifyOutgoingFilterRulesRequest(AdminFilterType::AFTER());
        ...
        $response = new ModifyOutgoingFilterRulesResponse();

        $body = new ModifyOutgoingFilterRulesBody($request, $response);
        $this->assertSame($request, $body->getRequest());
        $this->assertSame($response, $body->getResponse());
        $body = new ModifyOutgoingFilterRulesBody();
        $body->setRequest($request)
             ->setResponse($response);
        $this->assertSame($request, $body->getRequest());
        $this->assertSame($response, $body->getResponse());

        $envelope = new ModifyOutgoingFilterRulesEnvelope($body);
        $this->assertSame($body, $envelope->getBody());
        $envelope = new ModifyOutgoingFilterRulesEnvelope();
...
<soap:Envelope xmlns:soap="http://www.w3.org/2003/05/soap-envelope" xmlns:urn="urn:zimbraAdmin">
    <soap:Body>
        ...
        </urn:ModifyOutgoingFilterRulesRequest>
        <urn:ModifyOutgoingFilterRulesResponse />
    </soap:Body>
</soap:Envelope>
EOT;
        $this->assertXmlStringEqualsXmlString($xml, $this->serializer->serialize($envelope, 'xml'));
        $this->assertEquals($envelope, $this->serializer->deserialize($xml, ModifyOutgoingFilterRulesEnvelope::class, 'xml'));
        ...
        $this->assertEquals($envelope, $this->serializer->deserialize($json, ModifyOutgoingFilterRulesEnvelope::class, 'json'));
    }
}
