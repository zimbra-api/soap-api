 ...
 * @XmlRoot(name="RemoveAccountAliasRequest")
 */
class RemoveAccountAliasRequest extends Request
{
    /**
     * Zimbra ID
    ...
    {
        if (!($this->envelope instanceof RemoveAccountAliasEnvelope)) {
            $this->envelope = new RemoveAccountAliasEnvelope(
