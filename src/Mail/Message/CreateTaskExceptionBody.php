...
class CreateTaskExceptionBody extends SoapBody
{
     ...
     * Constructor
     *
     * @param  CreateTaskExceptionRequest $request
     * @param  CreateTaskExceptionResponse $response
     * @return self
     */
    public function __construct(
        ?CreateTaskExceptionRequest $request = null,
        ?CreateTaskExceptionResponse $response = null
    ) {
    ...
    {
        if ($request instanceof CreateTaskExceptionRequest) {
    ...
    {
        if ($response instanceof CreateTaskExceptionResponse) {
