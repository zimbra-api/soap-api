...
class DestroyWaitSetBody extends SoapBody
{
    ...
    #[SerializedName(name: 'DestroyWaitSetResponse')]
    #[Type(name: DestroyWaitSetResponse::class)]
    #[XmlElement(namespace: 'urn:zimbraMail')]
    private $response;
     ...
     * Constructor
     *
     * @param  DestroyWaitSetRequest $request
     * @param  DestroyWaitSetResponse $response
     * @return self
     */
