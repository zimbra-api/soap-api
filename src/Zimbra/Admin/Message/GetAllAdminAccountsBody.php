 ...
 * @XmlRoot(name="Body")
 */
class GetAllAdminAccountsBody extends Body
{
    /**
    ...
    /**
     * Constructor method for GetAllAdminAccountsBody
     * @return self
     */
    public function __construct(?GetAllAdminAccountsRequest $request = NULL, ?GetAllAdminAccountsResponse $response = NULL)
    {
