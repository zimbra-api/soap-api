...
/**
 * Testcase class for AccountImapDataSource.
 */
class AccountImapDataSourceTest extends ZimbraTestCase
{
    public function testAccountImapDataSource()
    {
        $id = $this->faker->uuid;
        ...
        $imap = new MockAccountImapDataSource(
...
EOT;
        ...
        $this->assertEquals($imap, $this->serializer->deserialize($xml, MockAccountImapDataSource::class, 'xml'));
    }
}

#[XmlNamespace(uri: 'urn:zimbraAccount', prefix: 'urn')]
class MockAccountImapDataSource extends AccountImapDataSource
{
}
