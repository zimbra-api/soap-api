 ...
 */
class GetOAuthConsumersEnvelope extends Envelope
{
    /**
    ...
    /**
     * Constructor method for GetOAuthConsumersEnvelope
     *
     * @return self
     */
    public function __construct(?GetOAuthConsumersBody $body = NULL, ?Header $header = NULL)
    {
