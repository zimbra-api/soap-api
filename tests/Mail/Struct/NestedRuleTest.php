...
class NestedRuleTest extends ZimbraTestCase
{
    ...
    public function testNestedRule()
    {
        ...
        $nestedRule = new StubNestedRule($filterTests, $filterVariables, [
            $filterVariables,
            $actionKeep,
            $actionDiscard,
            $actionFileInto,
        ...
        $this->assertSame($filterVariables, $nestedRule->getFilterVariables());
        $this->assertSame([
            $filterVariables,
            $actionKeep,
            $actionDiscard,
            ...
            $actionDeleteheader,
            $actionReplaceheader,
        ], array_values($nestedRule->getFilterActions()));
        $this->assertSame($child, $nestedRule->getChild());

        $nestedRule = new StubNestedRule(new FilterTests(FilterCondition::ALL_OF()));
...
EOT;
        ...
        $this->assertEquals($nestedRule, $this->serializer->deserialize($xml, StubNestedRule::class, 'xml'));
    }
}
 ...
 */
class StubNestedRule extends NestedRule
{
}
