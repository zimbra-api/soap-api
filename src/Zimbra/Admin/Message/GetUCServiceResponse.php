 ...
 * @XmlRoot(name="GetUCServiceResponse")
 */
class GetUCServiceResponse implements ResponseInterface
{
    /**
    ...
    /**
     * Constructor method for GetUCServiceResponse
