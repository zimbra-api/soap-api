...
class AccountCalDataSourceTest extends ZimbraTestCase
{
    public function testAccountCalDataSource()
    {
        ...
        $cal = new MockAccountCalDataSource(
...
EOT;
        ...
        $this->assertEquals($cal, $this->serializer->deserialize($xml, MockAccountCalDataSource::class, 'xml'));
    }
}

#[XmlNamespace(uri: 'urn:zimbraAccount', prefix: "urn")]
class MockAccountCalDataSource extends AccountCalDataSource
{
}
