 ...
 */
class GetVolumeEnvelope extends Envelope
{
    /**
     * @Accessor(getter="getBody", setter="setBody")
     * @SerializedName("Body")
     * @Type("Zimbra\Admin\Message\GetVolumeBody")
     * @XmlElement(namespace="http://www.w3.org/2003/05/soap-envelope")
     */
    private ?BodyInterface $body = NULL;

    /**
     * Constructor method for GetVolumeEnvelope
     *
     * @return self
     */
    public function __construct(?GetVolumeBody $body = NULL, ?Header $header = NULL)
    {
