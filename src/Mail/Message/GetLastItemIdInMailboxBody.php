...
class GetLastItemIdInMailboxBody extends SoapBody
{
     ...
     * Constructor
     *
     * @param  GetLastItemIdInMailboxRequest $request
     * @param  GetLastItemIdInMailboxResponse $response
     * @return self
     */
    public function __construct(
        ?GetLastItemIdInMailboxRequest $request = null,
        ?GetLastItemIdInMailboxResponse $response = null
    ) {
