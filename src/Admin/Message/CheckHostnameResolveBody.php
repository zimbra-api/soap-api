...
class CheckHostnameResolveBody extends SoapBody
{
     ...
     */
    #[Accessor(getter: 'getResponse', setter: 'setResponse')]
    #[SerializedName(name: 'CheckHostnameResolveResponse')]
    #[Type(name: CheckHostnameResolveResponse::class)]
    #[XmlElement(namespace: 'urn:zimbraAdmin')]
    private $response;
     ...
     * Constructor
     *
     * @param CheckHostnameResolveRequest $request
     * @param CheckHostnameResolveResponse $response
     * @return self
     */
