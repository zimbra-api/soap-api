 ...
 */
class FixCalendarEndTimeBody extends SoapBody
{
    /**
    ...
    #[SerializedName(name: 'FixCalendarEndTimeResponse')]
    #[Type(name: FixCalendarEndTimeResponse::class)]
    #[XmlElement(namespace: 'urn:zimbraAdmin')]
    private $response;
