 ...
 */
class GetWorkingHoursEnvelope extends Envelope
{
    /**
    ...
    /**
     * Constructor method for GetWorkingHoursEnvelope
     *
     * @return self
     */
    public function __construct(?GetWorkingHoursBody $body = NULL, ?Header $header = NULL)
    {
