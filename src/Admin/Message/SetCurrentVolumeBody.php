...
class SetCurrentVolumeBody extends SoapBody
{
     ...
     * Constructor
     *
     * @param SetCurrentVolumeRequest $request
     * @param SetCurrentVolumeResponse $response
     * @return self
     */
    public function __construct(
        ?SetCurrentVolumeRequest $request = null,
        ?SetCurrentVolumeResponse $response = null
    ) {
