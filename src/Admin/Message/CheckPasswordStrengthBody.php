...
class CheckPasswordStrengthBody extends SoapBody
{
    ...
    #[SerializedName(name: 'CheckPasswordStrengthResponse')]
    #[Type(name: CheckPasswordStrengthResponse::class)]
    #[XmlElement(namespace: 'urn:zimbraAdmin')]
    private $response;
     ...
     * Constructor
     *
     * @param CheckPasswordStrengthRequest $request
     * @param CheckPasswordStrengthResponse $response
     * @return self
     */
