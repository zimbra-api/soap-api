 ...
 */
class EmptyDumpsterBody extends Body
{
    /**
    ...
    /**
     * Constructor method for EmptyDumpsterBody
     *
     * @return self
     */
    ...
    {
        if ($request instanceof EmptyDumpsterRequest) {
    ...
    {
        if ($response instanceof EmptyDumpsterResponse) {
