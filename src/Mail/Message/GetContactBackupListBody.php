...
class GetContactBackupListBody extends SoapBody
{
    ...
    #[SerializedName(name: 'GetContactBackupListRequest')]
    #[Type(name: GetContactBackupListRequest::class)]
     ...
     * Constructor
     *
     * @param  GetContactBackupListRequest $request
     * @param  GetContactBackupListResponse $response
     * @return self
     */
