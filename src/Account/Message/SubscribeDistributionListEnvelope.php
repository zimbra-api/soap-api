 ...
 */
class SubscribeDistributionListEnvelope extends Envelope
{
    /**
    ...
    /**
     * Constructor method for SubscribeDistributionListEnvelope
     *
     * @return self
     */
    public function __construct(?SubscribeDistributionListBody $body = NULL, ?Header $header = NULL)
    {
