 ...
 */
class CheckPermissionEnvelope extends Envelope
{
    /**
    ...
    /**
     * Constructor method for CheckPermissionEnvelope
     *
     * @return self
     */
    public function __construct(?CheckPermissionBody $body = NULL, ?Header $header = NULL)
    {
    ...
    {
        if ($body instanceof CheckPermissionBody) {
            $this->body = $body;
        }
        return $this;
    }
