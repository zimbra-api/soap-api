...
/**
 * CompleteTaskInstanceEnvelope class
 * 
 * @package    Zimbra
 * @subpackage Mail
 * @category   Message
 ...
 */
class CompleteTaskInstanceEnvelope extends Envelope
{
    /**
    ...
    /**
     * Constructor method for CompleteTaskInstanceEnvelope
     *
     * @return self
     */
    public function __construct(?CompleteTaskInstanceBody $body = NULL, ?Header $header = NULL)
    {
    ...
    {
        if ($body instanceof CompleteTaskInstanceBody) {
            $this->body = $body;
        }
        return $this;
    }
