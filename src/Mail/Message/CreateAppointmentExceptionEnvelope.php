...
/**
 * CreateAppointmentExceptionEnvelope class
 * 
 * @package    Zimbra
 * @subpackage Mail
 * @category   Message
 ...
 */
class CreateAppointmentExceptionEnvelope extends Envelope
{
    /**
    ...
    /**
     * Constructor method for CreateAppointmentExceptionEnvelope
     *
     * @return self
     */
    public function __construct(?CreateAppointmentExceptionBody $body = NULL, ?Header $header = NULL)
    {
    ...
    {
        if ($body instanceof CreateAppointmentExceptionBody) {
            $this->body = $body;
        }
        return $this;
    }
