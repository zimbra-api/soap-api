...
use Zimbra\Mail\Message\ModifyFilterRulesEnvelope;
use Zimbra\Mail\Message\ModifyFilterRulesBody;
use Zimbra\Mail\Message\ModifyFilterRulesRequest;
use Zimbra\Mail\Message\ModifyFilterRulesResponse;
...
class ModifyFilterRulesTest extends ZimbraTestCase
{
    public function testModifyFilterRules()
    {
        ...
        $request = new ModifyFilterRulesRequest([$filterRule]);
