...
class RenameLDAPEntryBody extends SoapBody
{
     ...
     */
    #[Accessor(getter: 'getRequest', setter: 'setRequest')]
    #[SerializedName(name: 'RenameLDAPEntryRequest')]
    #[Type(name: RenameLDAPEntryRequest::class)]
    #[XmlElement(namespace: 'urn:zimbraAdmin')]
    private $request;
     ...
     */
    #[Accessor(getter: 'getResponse', setter: 'setResponse')]
    #[SerializedName(name: 'RenameLDAPEntryResponse')]
    #[Type(name: RenameLDAPEntryResponse::class)]
    #[XmlElement(namespace: 'urn:zimbraAdmin')]
    private $response;
     ...
     * Constructor
     *
     * @param RenameLDAPEntryRequest $request
     * @param RenameLDAPEntryResponse $response
     * @return self
     */
