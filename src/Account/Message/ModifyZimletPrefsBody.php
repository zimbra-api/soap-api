...
class ModifyZimletPrefsBody extends SoapBody
{
    ...
    #[Type(name: ModifyZimletPrefsRequest::class)]
    #[XmlElement(namespace: 'urn:zimbraAccount')]
    private $request;

    /**
     * @var ModifyZimletPrefsResponse
     */
    #[Accessor(getter: 'getResponse', setter: 'setResponse')]
    #[SerializedName(name: 'ModifyZimletPrefsResponse')]
    #[Type(name: ModifyZimletPrefsResponse::class)]
    #[XmlElement(namespace: 'urn:zimbraAccount')]
    private $response;
     ...
     * Constructor
     *
     * @param  ModifyZimletPrefsRequest $request
     * @param  ModifyZimletPrefsResponse $response
     * @return self
     */
