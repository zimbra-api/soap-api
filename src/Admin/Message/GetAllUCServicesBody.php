...
class GetAllUCServicesBody extends SoapBody
{
     ...
     */
    #[Accessor(getter: 'getResponse', setter: 'setResponse')]
    #[SerializedName(name: 'GetAllUCServicesResponse')]
    #[Type(name: GetAllUCServicesResponse::class)]
    #[XmlElement(namespace: 'urn:zimbraAdmin')]
    private $response;
     ...
     * Constructor
     *
     * @param GetAllUCServicesRequest $request
     * @param GetAllUCServicesResponse $response
     * @return self
     */
