 ...
 */
class AutoCompleteEnvelope extends Envelope
{
    /**
    ...
    /**
     * Constructor method for AutoCompleteEnvelope
     *
     * @return self
     */
    public function __construct(?AutoCompleteBody $body = NULL, ?Header $header = NULL)
    {
    ...
    {
        if ($body instanceof AutoCompleteBody) {
            $this->body = $body;
        }
        return $this;
    }
