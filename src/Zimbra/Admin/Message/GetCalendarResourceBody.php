 ...
 * @XmlRoot(name="Body")
 */
class GetCalendarResourceBody extends Body
{
    /**
    ...
    /**
     * Constructor method for GetCalendarResourceBody
     * @return self
     */
    public function __construct(?GetCalendarResourceRequest $request = NULL, ?GetCalendarResourceResponse $response = NULL)
    {
