...
use Zimbra\Mail\Request\SetAppointment;
 ...
 */
class SetAppointmentTest extends ZimbraMailApiTestCase
{
    public function testSetAppointmentRequest()
    {
        ...
        $xml = '<?xml version="1.0"?>'."\n"
            .'<SetAppointmentRequest f="' . $f . '" t="' . $t . '" tn="' . $tn . '" l="' . $l . '" noNextAlarm="true" nextAlarm="' . $nextAlarm . '">'
    ...
    public function testSetAppointmentApi()
    {
        ...
        $xml = '<?xml version="1.0"?>'."\n"
            .'<env:Envelope xmlns:env="http://www.w3.org/2003/05/soap-envelope" xmlns:urn="urn:zimbra" xmlns:urn1="urn:zimbraMail">'
                .'<env:Body>'
                    .'<urn1:SetAppointmentRequest f="' . $f . '" t="' . $t . '" tn="' . $tn . '" l="' . $l . '" noNextAlarm="true" nextAlarm="' . $nextAlarm . '">'
