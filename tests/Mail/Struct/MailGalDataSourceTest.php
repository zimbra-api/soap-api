 ...
 */
class MailGalDataSourceTest extends ZimbraTestCase
{
    public function testMailGalDataSource()
    {
        ...
        $this->assertTrue($gal instanceof MailDataSource);
...
EOT;
        ...
        $this->assertEquals($gal, $this->serializer->deserialize($xml, MailGalDataSource::class, 'xml'));
        ...
        $this->assertEquals($gal, $this->serializer->deserialize($json, MailGalDataSource::class, 'json'));
    }
}
