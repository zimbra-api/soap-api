...
use Zimbra\Mail\Request\ModifyOutgoingFilterRules;

/**
 * Testcase class for ModifyOutgoingFilterRules.
 */
class ModifyOutgoingFilterRulesTest extends ZimbraMailApiTestCase
{
    public function testModifyOutgoingFilterRulesRequest()
    {
        ...
        $req = new ModifyOutgoingFilterRules(
            $filterRules
        );
    ...
    public function testModifyOutgoingFilterRulesApi()
    {
        $name = $this->faker->word;
        $index = mt_rand(1, 100);
        $header = $this->faker->word;
        ...
        $this->api->modifyOutgoingFilterRules(
            $filterRules
        );
