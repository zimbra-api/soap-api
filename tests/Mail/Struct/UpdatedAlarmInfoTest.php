...
EOT;
        ...
        $this->assertJsonStringEqualsJsonString($json, $this->serializer->serialize($updated, 'json'));
        $this->assertEquals($updated, $this->serializer->deserialize($json, UpdatedAlarmInfo::class, 'json'));
    }
}
