...
class ExpandedRecurrenceExceptionTest extends ZimbraTestCase
{
    public function testExpandedRecurrenceException()
    {
        ...
        $except = new StubExpandedRecurrenceException($exceptionId, $startTime, $endTime, $duration, $recurrence);
...
EOT;
        ...
        $this->assertEquals($except, $this->serializer->deserialize($xml, StubExpandedRecurrenceException::class, 'xml'));
    }
}

#[XmlNamespace(uri: 'urn:zimbraMail', prefix: 'urn')]
class StubExpandedRecurrenceException extends ExpandedRecurrenceException
{
}
