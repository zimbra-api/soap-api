 ...
 */
class CancelAppointmentEnvelope extends Envelope
{
    /**
    ...
    /**
     * Constructor method for CancelAppointmentEnvelope
     *
     * @return self
     */
    public function __construct(?CancelAppointmentBody $body = NULL, ?Header $header = NULL)
    {
