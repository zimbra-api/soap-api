...
/**
 * Testcase class for TzFixupRule.
 */
class TzFixupRuleTest extends ZimbraStructTestCase
{
    public function testTzFixupRule()
    {
        ...
        $fixupRule = $this->serializer->deserialize($xml, 'Zimbra\Admin\Struct\TzFixupRule', 'xml');
