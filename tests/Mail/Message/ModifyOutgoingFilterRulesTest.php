...
use Zimbra\Mail\Message\ModifyOutgoingFilterRulesEnvelope;
use Zimbra\Mail\Message\ModifyOutgoingFilterRulesBody;
use Zimbra\Mail\Message\ModifyOutgoingFilterRulesRequest;
use Zimbra\Mail\Message\ModifyOutgoingFilterRulesResponse;
...
/**
 * Testcase class for ModifyOutgoingFilterRules.
 */
class ModifyOutgoingFilterRulesTest extends ZimbraTestCase
{
    public function testModifyOutgoingFilterRules()
    {
        ...
        $request = new ModifyOutgoingFilterRulesRequest([$filterRule]);
        $this->assertSame([$filterRule], $request->getFilterRules());
        $request = new ModifyOutgoingFilterRulesRequest();
        $request->setFilterRules([$filterRule])->addFilterRule($filterRule);
