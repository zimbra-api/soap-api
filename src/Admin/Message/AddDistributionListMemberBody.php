 ...
 */
class AddDistributionListMemberBody extends SoapBody
{
    /**
     ...
     * @XmlElement(namespace="urn:zimbraAdmin")
     * 
     * @var AddDistributionListMemberResponse
     */
    #[Accessor(getter: 'getResponse', setter: 'setResponse')]
    #[SerializedName(name: 'AddDistributionListMemberResponse')]
    #[Type(name: AddDistributionListMemberResponse::class)]
    #[XmlElement(namespace: 'urn:zimbraAdmin')]
    private $response;
     ...
     * Constructor
     *
     * @param AddDistributionListMemberRequest $request
     * @param AddDistributionListMemberResponse $response
     * @return self
     */
