...
class Context
{
     ...
     * @Type("Zimbra\Common\Soap\Header\SessionInfo")
     ...
     * @Type("Zimbra\Common\Soap\Header\AccountInfo")
     * @XmlElement(namespace="urn:zimbra")
     */
     ...
     * @Type("Zimbra\Common\Soap\Header\ChangeInfo")
     * @XmlElement(namespace="urn:zimbra")
     */
     ...
     * @Type("Zimbra\Common\Soap\Header\UserAgentInfo")
     * @XmlElement(namespace="urn:zimbra")
     */
     ...
     * @Type("Zimbra\Common\Soap\Header\FormatInfo")
     * @XmlElement(namespace="urn:zimbra")
     */
     ...
     * @Type("Zimbra\Common\Soap\Header\NotifyInfo")
     * @XmlElement(namespace="urn:zimbra")
     */
