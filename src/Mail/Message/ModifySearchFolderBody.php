...
class ModifySearchFolderBody extends SoapBody
{
     ...
     * Constructor
     *
     * @param  ModifySearchFolderRequest $request
     * @param  ModifySearchFolderResponse $response
     * @return self
     */
    public function __construct(
        ?ModifySearchFolderRequest $request = null,
        ?ModifySearchFolderResponse $response = null
    ) {
