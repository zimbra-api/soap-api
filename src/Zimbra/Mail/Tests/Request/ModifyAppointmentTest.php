...
use Zimbra\Mail\Request\ModifyAppointment;
use Zimbra\Mail\Struct\Msg;

/**
 * Testcase class for ModifyAppointment.
 */
class ModifyAppointmentTest extends ZimbraMailApiTestCase
{
    public function testModifyAppointmentRequest()
    {
        $id = $this->faker->uuid;
        $comp = mt_rand(1, 10);
        $ms = mt_rand(1, 10);
        ...
        $xml = '<?xml version="1.0"?>'."\n"
            .'<ModifyAppointmentRequest id="' . $id . '" comp="' . $comp . '" ms="' . $ms . '" rev="' . $rev . '" echo="true" max="' . $max . '" html="true" neuter="true" forcesend="true">'
    ...
    public function testModifyAppointmentApi()
    {
        $id = $this->faker->uuid;
        $comp = mt_rand(1, 10);
        $ms = mt_rand(1, 10);
        ...
        $xml = '<?xml version="1.0"?>'."\n"
            .'<env:Envelope xmlns:env="http://www.w3.org/2003/05/soap-envelope" xmlns:urn="urn:zimbra" xmlns:urn1="urn:zimbraMail">'
                .'<env:Body>'
                    .'<urn1:ModifyAppointmentRequest id="' . $id . '" comp="' . $comp . '" ms="' . $ms . '" rev="' . $rev . '" echo="true" max="' . $max . '" html="true" neuter="true" forcesend="true">'
