 ...
 */
class ModifyLDAPEntryEnvelope extends Envelope
{
    /**
     ...
     * @return self
     */
    public function __construct(?ModifyLDAPEntryBody $body = NULL, ?Header $header = NULL)
    {
    ...
    {
        if ($body instanceof ModifyLDAPEntryBody) {
            $this->body = $body;
        }
        return $this;
    }
