 ...
 */
class ForwardAppointmentEnvelope extends Envelope
{
    /**
    ...
    /**
     * Constructor method for ForwardAppointmentEnvelope
     *
     * @return self
     */
    public function __construct(?ForwardAppointmentBody $body = NULL, ?Header $header = NULL)
    {
