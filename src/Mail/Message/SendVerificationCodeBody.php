...
/**
 * SendVerificationCodeBody class
 *
 * @package    Zimbra
 * @subpackage Mail
 * @category   Message
...
class SendVerificationCodeBody extends SoapBody
{
     ...
     * @param  SendVerificationCodeResponse $response
     * @return self
     */
    public function __construct(
        ?SendVerificationCodeRequest $request = null,
        ?SendVerificationCodeResponse $response = null
    ) {
    ...
    {
        if ($request instanceof SendVerificationCodeRequest) {
    ...
    {
        if ($response instanceof SendVerificationCodeResponse) {
