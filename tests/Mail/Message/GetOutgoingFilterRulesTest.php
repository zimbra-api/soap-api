...
use Zimbra\Mail\Message\GetOutgoingFilterRulesEnvelope;
use Zimbra\Mail\Message\GetOutgoingFilterRulesBody;
use Zimbra\Mail\Message\GetOutgoingFilterRulesRequest;
use Zimbra\Mail\Message\GetOutgoingFilterRulesResponse;
...
class GetOutgoingFilterRulesTest extends ZimbraTestCase
{
    public function testGetOutgoingFilterRules()
    {
        ...
        $response = new GetOutgoingFilterRulesResponse([$filterRule]);
