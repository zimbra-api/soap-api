 ...
 * @XmlRoot(name="ModifyCosRequest")
 */
class ModifyCosRequest extends Request implements AdminAttrs
{
    ...
    {
        if (!($this->envelope instanceof ModifyCosEnvelope)) {
            $this->envelope = new ModifyCosEnvelope(
