 ...
 */
class GetLastItemIdInMailboxEnvelope extends Envelope
{
    /**
     * @Accessor(getter="getBody", setter="setBody")
     * @SerializedName("Body")
     * @Type("Zimbra\Mail\Message\GetLastItemIdInMailboxBody")
     * @XmlElement(namespace="http://www.w3.org/2003/05/soap-envelope")
     */
    private ?BodyInterface $body = NULL;

    /**
     * Constructor method for GetLastItemIdInMailboxEnvelope
     *
     * @return self
     */
    public function __construct(?GetLastItemIdInMailboxBody $body = NULL, ?Header $header = NULL)
    {
