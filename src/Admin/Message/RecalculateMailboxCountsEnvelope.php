...
/**
 * RecalculateMailboxCountsEnvelope class
 *
 * @package    Zimbra
 * @subpackage Admin
 * @category   Message
...
class RecalculateMailboxCountsEnvelope extends SoapEnvelope
{
     ...
     * Constructor
     *
     * @param RecalculateMailboxCountsBody $body
     * @param SoapHeaderInterface $header
     * @return self
     */
    public function __construct(
        ?RecalculateMailboxCountsBody $body = null,
    ...
    {
        if ($body instanceof RecalculateMailboxCountsBody) {
            $this->body = $body;
        }
        return $this;
    }
