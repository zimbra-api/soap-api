 ...
 */
class AddMsgEnvelope extends Envelope
{
    /**
    ...
    /**
     * Constructor method for AddMsgEnvelope
     *
     * @return self
     */
    public function __construct(?AddMsgBody $body = NULL, ?Header $header = NULL)
    {
