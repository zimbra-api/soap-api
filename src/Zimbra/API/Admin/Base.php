...
use Zimbra\Soap\Struct\DeviceId;
...
use Zimbra\Soap\Struct\ExportAndDeleteMailboxSpec as ExportMailbox;
...
use Zimbra\Soap\Struct\IdAndAction;
use Zimbra\Soap\Struct\IdStatus;
use Zimbra\Soap\Struct\LimitedQuery;
use Zimbra\Soap\Struct\LoggerInfo as Logger;
use Zimbra\Soap\Struct\MailboxByAccountIdSelector as MailboxId;
...
use Zimbra\Soap\Struct\ReindexMailboxInfo as ReindexMailbox;
use Zimbra\Soap\Struct\RightModifierInfo as RightModifier;
use Zimbra\Soap\Struct\ServerSelector as Server;
use Zimbra\Soap\Struct\ServerMailQueueQuery as ServerMail;
use Zimbra\Soap\Struct\ServerWithQueueAction as ServerQueue;
use Zimbra\Soap\Struct\SyncGalAccountSpec as SyncGalAccount;
use Zimbra\Soap\Struct\StatsSpec;
use Zimbra\Soap\Struct\TargetWithType;
...
use Zimbra\Soap\Struct\XmppComponentSelector as XmppComponent;
use Zimbra\Soap\Struct\XmppComponentSpec as Xmpp;
use Zimbra\Soap\Struct\ZimletAclStatusPri as ZimletAcl;
...
abstract class Base extends Admin implements AdminInterface
{
    ...
    {
        $request = new \Zimbra\API\Admin\Request\AddAccountAlias(
            $id, $alias
        );
    ...
    {
        $request = new \Zimbra\API\Admin\Request\AddAccountLogger(
            $logger, $account
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\AddDistributionListAlias(
            $id, $alias
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\AddDistributionListMember(
            $id, $dlms
        );
        return $this->_client->doRequest($request);
    }
    ...
    public function addGalSyncDataSource(
        ...
        array $attrs = array())
    {
        $request = new \Zimbra\API\Admin\Request\AddGalSyncDataSource(
    ...
    public function adminCreateWaitSet(
        ...
        $allAccounts = null)
    {
        $request = new \Zimbra\API\Admin\Request\AdminCreateWaitSet(
    ...
    {
        $request = new \Zimbra\API\Admin\Request\AdminDestroyWaitSet(
            $waitSet
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\AdminWaitSet(
    ...
    {
        $request = new \Zimbra\API\Admin\Request\Auth(
    ...
    public function autoCompleteGal(
        ...
        $limit = null)
    {
        $request = new \Zimbra\API\Admin\Request\AutoCompleteGal(
    ...
    public function autoProvAccount(
        ...
        $password = null)
    {
        $request = new \Zimbra\API\Admin\Request\AutoProvAccount(
    ...
    {
        $request = new \Zimbra\API\Admin\Request\AutoProvTaskControl(
            $action
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\CheckAuthConfig(
            $name, $password, $attrs
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\CheckBlobConsistency(
    ...
    {
        $request = new \Zimbra\API\Admin\Request\CheckDirectory(
            $directories
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\CheckDomainMXRecord(
            $domain
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\CheckExchangeAuth(
            $auth
        );
        return $this->_client->doRequest($request);
    }
    ...
    public function checkGalConfig(
        ...
        array $attrs = array())
    {
        $request = new \Zimbra\API\Admin\Request\CheckGalConfig(
            $query, $action, $attrs
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\CheckHealth;
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\CheckHostnameResolve(
            $hostname
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\CheckPasswordStrength(
            $id, $password
        );
        return $this->_client->doRequest($request);
    }
    ...
    public function checkRights(
        ...
        array $attrs = array())
    {
        $request = new \Zimbra\API\Admin\Request\CheckRights(
    ...
    {
        $request = new \Zimbra\API\Admin\Request\ClearCookie(
            $cookies
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\CompactIndex(
            $mbox, $action
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\ComputeAggregateQuotaUsage;
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\ConfigureZimlet(
            $content
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\CopyCos(
            $name, $cos
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\CountAccount(
            $domain
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\CountObjects(
    ...
    {
        $request = new \Zimbra\API\Admin\Request\CreateAccount(
            $name, $password, $attrs
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\CreateCalendarResource(
            $name, $password, $attrs
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\CreateCos(
            $name, $attrs
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\CreateDataSource(
            $id, $dataSource
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\CreateDistributionList(
            $name, $dynamic, $attrs
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\CreateDomain(
            $name, $attrs
        );
        return $this->_client->doRequest($request);
    }
    ...
    public function createGalSyncAccount(
        ...
        array $attrs = array())
    {
        $request = new \Zimbra\API\Admin\Request\CreateGalSyncAccount(
    ...
    {
        $request = new \Zimbra\API\Admin\Request\CreateLDAPEntry(
            $name, $attrs
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\CreateServer(
            $name, $attrs
        );
        return $this->_client->doRequest($request);
    }
    ...
    public function createSystemRetentionPolicy(
        ...
        Policy $purge = null)
    {
        $request = new \Zimbra\API\Admin\Request\CreateSystemRetentionPolicy(
            $cos, $keep, $purge
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\CreateUCService(
            $name, $attrs
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\CreateVolume(
            $volume
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\CreateXMPPComponent(
            $xmpp
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\CreateZimlet(
            $name, $attrs
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\DedupeBlobs(
            $action, $volumes
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\DelegateAuth(
            $account, $duration
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\DeleteAccount(
            $id
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\DeleteCalendarResource(
            $id
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\DeleteCos(
            $id
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\DeleteDataSource(
            $id, $dataSource, $attrs
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\DeleteDistributionList(
            $id
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\DeleteDomain(
            $id
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\DeleteGalSyncAccount(
            $account
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\DeleteLDAPEntry(
            $dn
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\DeleteMailbox(
            $id
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\DeleteServer(
            $id
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\DeleteSystemRetentionPolicy(
            $policy, $cos
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\DeleteUCService(
            $id
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\DeleteVolume(
            $id
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\DeleteXMPPComponent(
            $xmpp
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\DeleteZimlet(
            $zimlet
        );
        return $this->_client->doRequest($request);
    }
    ...
    function deployZimlet(
        ...
        $synchronous = null)
    {
        $request = new \Zimbra\API\Admin\Request\DeployZimlet(
    ...
    {
        $request = new \Zimbra\API\Admin\Request\DumpSessions(
            $list, $groupBy
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\ExportAndDeleteItems(
    ...
    {
        $request = new \Zimbra\API\Admin\Request\FixCalendarEndTime(
            $sync, $accounts
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\FixCalendarPriority(
            $sync, $accounts
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\FixCalendarTZ(
    ...
    {
        $request = new \Zimbra\API\Admin\Request\FlushCache(
            $cache
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GenCSR(
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetAccount(
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetAccountInfo(
            $account
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetAccountLoggers(
            $account
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetAccountMembership(
            $account
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetAdminConsoleUIComp(
            $account, $dl
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetAdminExtensionZimlets;
        return $this->_client->doRequest($request);
    }
     ...
     * @return mix
     */
    public function getAdminSavedSearches(NamedElement $search)
    {
        $request = new \Zimbra\API\Admin\Request\GetAdminSavedSearches(
            $search
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetAggregateQuotaUsageOnServer;
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetAllAccountLoggers;
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetAllAccounts(
            $server, $domain
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetAllAdminAccounts(
            $applyCos
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetAllCalendarResources(
            $server, $domain
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetAllConfig;
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetAllCos;
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetAllDistributionLists(
            $domain
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetAllDomains(
            $applyConfig
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetEffectiveRights(
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetAllFreeBusyProviders;
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetAllLocales;
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetAllMailboxes(
            $limit, $offset
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetAllRights(
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetAllServers(
            $service, $applyConfig
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetAllSkins;
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetAllUCProviders;
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetAllUCServices;
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetAllVolumes;
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetAllXMPPComponents;
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetAllZimlets(
            $exclude
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetAttributeInfo(
            $attrs, $entryTypes
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetCalendarResource(
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetCert(
            $server, $type, $option
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetConfig($attrs);
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetCos($cos, $attrs);
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetCreateObjectAttrs(
            $target, $domain, $cos
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetCSR($server, $type);
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetCurrentVolumes;
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetDataSources($id, $attrs);
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetDelegatedAdminConstraints(
            $type, $id, $name, $attrs
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetDevices($account);
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetDistributionList(
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetDistributionListMembership(
            $dl, $limit, $offset
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetDomain(
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetDomainInfo(
            $domain, $applyConfig
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetFreeBusyQueueInfo($provider);
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetGrants($target, $grantee);
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetIndexStats($mbox);
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\getLDAPEntries(
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetLicenseInfo;
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetLoggerStats(
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetMailbox(
            $mbox
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetMailboxStats;
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetMailQueue($server);
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetMailQueueInfo($server);
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetMemcachedClientConfig;
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetQuotaUsage(
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetRight(
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetRightsDoc($packages);
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetServer(
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetServerNIfs(
            $server, $type
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetServerStats($stats);
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetServiceStatus;
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetSessions(
    ...
    {
        $request = new \Zimbra\API\Admin\Request\getShareInfo(
            $owner, $grantee
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetSystemRetentionPolicy(
            $cos
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetUCService(
            $ucservice, $attrs
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetVersionInfo;
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetVolume($id);
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\getXMPPComponent($xmpp, $attrs);
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetZimlet($name, $attrs);
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GetZimletStatus;
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\GrantRight(
    ...
    {
        $request = new \Zimbra\API\Admin\Request\MailQueueAction($server);
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\MailQueueFlush($server);
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\MigrateAccount($migrate);
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\ModifyAccount($id, $attrs);
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\ModifyAdminSavedSearches($searchs);
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\ModifyCalendarResource($id, $attrs);
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\ModifyConfig($attrs);
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\ModifyCos($id, $attrs);
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\ModifyDataSource(
            $id, $dataSource, $attrs
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\ModifyDelegatedAdminConstraints(
            $type, $id, $name, $attrs
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\ModifyDistributionList(
            $id, $attrs
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\ModifyDomain(
            $id, $attrs
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\ModifyLDAPEntry(
            $dn, $attrs
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\ModifyServer(
            $id, $attrs
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\ModifySystemRetentionPolicy(
            $policy, $cos
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\ModifyUCService(
            $id, $attrs
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\ModifyVolume(
            $id, $volume
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\ModifyZimlet(
            $zimlet
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\NoOp;
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\Ping;
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\PurgeAccountCalendarCache(
            $id
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\PurgeFreeBusyQueue(
            $provider
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\PurgeMessages(
            $mbox
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\PushFreeBusy(
            $domain, $account
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\QueryWaitSet(
            $waitSet
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\ReIndex(
            $mbox, $action
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\RecalculateMailboxCounts(
            $mbox
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\ReloadLocalConfig();
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\ReloadMemcachedClientConfig();
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\RemoveAccountAlias(
            $alias, $id
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\RemoveAccountLogger(
            $account, $logger
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\RemoveDevice(
            $account, $device
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\RemoveDistributionListAlias(
            $id, $alias
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\RemoveDistributionListMember(
            $id, $dlms
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\RenameAccount(
            $id, $newName
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\RenameCalendarResource(
            $id, $newName
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\RenameCos(
            $id, $newName
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\RenameDistributionList(
            $id, $newName
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\RenameLDAPEntry(
            $dn, $new_dn
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\RenameUCService(
            $id, $newName
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\ResetAllLoggers();
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\ResumeDevice(
            $account, $device
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\RevokeRight(
            $target, $grantee, $right
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\RunUnitTests(
            $tests
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\SearchAccounts(
    ...
    {
        $request = new \Zimbra\API\Admin\Request\SearchAutoProvDirectory(
    ...
    {
        $request = new \Zimbra\API\Admin\Request\SearchCalendarResources(
    ...
    {
        $request = new \Zimbra\API\Admin\Request\SearchDirectory(
    ...
    {
        $request = new \Zimbra\API\Admin\Request\SearchGal(
    ...
    {
        $request = new \Zimbra\API\Admin\Request\SetCurrentVolume(
            $id, $type
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\SetPassword(
            $id, $newPassword
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\SuspendDevice(
            $account, $device
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\SyncGalAccount(
            $account
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\undeployZimlet(
            $name, $action
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\UpdateDeviceStatus(
            $account, $device
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\UpdatePresenceSessionId(
    ...
    {
        $request = new \Zimbra\API\Admin\Request\UploadDomCert(
    ...
    {
        $request = new \Zimbra\API\Admin\Request\UploadProxyCA(
    ...
    {
        $request = new \Zimbra\API\Admin\Request\VerifyCertKey(
            $cert, $privkey
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\VerifyIndex(
            $id
        );
        return $this->_client->doRequest($request);
    }
    ...
    {
        $request = new \Zimbra\API\Admin\Request\VerifyStoreManager(
    ...
    {
        $request = new \Zimbra\API\Admin\Request\VersionCheck(
            $action
        );
        return $this->_client->doRequest($request);
    }
