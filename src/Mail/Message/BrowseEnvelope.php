 ...
 */
class BrowseEnvelope extends Envelope
{
    /**
     * @Accessor(getter="getBody", setter="setBody")
     * @SerializedName("Body")
     * @Type("Zimbra\Mail\Message\BrowseBody")
     * @XmlElement(namespace="http://www.w3.org/2003/05/soap-envelope")
     */
    private $body;

    /**
     * Constructor method for BrowseEnvelope
     *
     * @return self
     */
    public function __construct(?BrowseBody $body = NULL, ?Header $header = NULL)
    {
