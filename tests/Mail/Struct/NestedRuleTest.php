...
class NestedRuleTest extends ZimbraTestCase
{
    ...
    public function testNestedRule()
    {
        ...
        $nestedRule = new NestedRule($filterTests, $filterVariables, [
            $filterVariables,
            $actionKeep,
            $actionDiscard,
            $actionFileInto,
...
EOT;
        ...
        $this->assertJsonStringEqualsJsonString($json, $this->serializer->serialize($nestedRule, 'json'));
        $this->assertEquals($nestedRule, $this->serializer->deserialize($json, NestedRule::class, 'json'));
    }
}
