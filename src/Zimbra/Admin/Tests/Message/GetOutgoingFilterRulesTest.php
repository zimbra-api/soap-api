...
use Zimbra\Admin\Message\GetOutgoingFilterRulesBody;
use Zimbra\Admin\Message\GetOutgoingFilterRulesEnvelope;
use Zimbra\Admin\Message\GetOutgoingFilterRulesRequest;
use Zimbra\Admin\Message\GetOutgoingFilterRulesResponse;
...
/**
 * Testcase class for GetOutgoingFilterRulesTest.
 */
class GetOutgoingFilterRulesTest extends ZimbraStructTestCase
{
    ...
    public function testGetOutgoingFilterRules()
    {
        ...
        $response = new GetOutgoingFilterRulesResponse($type, $account, $domain, $cos, $server, [$filterRule]);
        ...
        $body = new GetOutgoingFilterRulesBody($request, $response);
        $this->assertSame($request, $body->getRequest());
        $this->assertSame($response, $body->getResponse());
        $body = new GetOutgoingFilterRulesBody();
        $body->setRequest($request)
             ->setResponse($response);
        $this->assertSame($request, $body->getRequest());
        $this->assertSame($response, $body->getResponse());

        $envelope = new GetOutgoingFilterRulesEnvelope($body);
        $this->assertSame($body, $envelope->getBody());
        $envelope = new GetOutgoingFilterRulesEnvelope();
...
EOT;
        ...
        $this->assertEquals($envelope, $this->serializer->deserialize($xml, GetOutgoingFilterRulesEnvelope::class, 'xml'));
        ...
        $this->assertEquals($envelope, $this->serializer->deserialize($json, GetOutgoingFilterRulesEnvelope::class, 'json'));
    }
}
