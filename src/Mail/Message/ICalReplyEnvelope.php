 ...
 */
class ICalReplyEnvelope extends Envelope
{
    /**
    ...
    /**
     * Constructor method for ICalReplyEnvelope
     *
     * @return self
     */
    public function __construct(?ICalReplyBody $body = NULL, ?Header $header = NULL)
    {
    ...
    {
        if ($body instanceof ICalReplyBody) {
            $this->body = $body;
        }
        return $this;
    }
