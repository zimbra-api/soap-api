...
class GetDataSourceUsageBody extends SoapBody
{
     ...
     */
    #[Accessor(getter: 'getRequest', setter: 'setRequest')]
    #[SerializedName(name: 'GetDataSourceUsageRequest')]
    #[Type(name: GetDataSourceUsageRequest::class)]
    #[XmlElement(namespace: 'urn:zimbraMail')]
    private $request;
     ...
     * Constructor
     *
     * @param  GetDataSourceUsageRequest $request
     * @param  GetDataSourceUsageResponse $response
     * @return self
     */
