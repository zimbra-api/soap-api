 ...
 */
class ResetPasswordEnvelope extends Envelope
{
    /**
    ...
    /**
     * Constructor method for ResetPasswordEnvelope
     *
     * @return self
     */
    public function __construct(?ResetPasswordBody $body = NULL, ?Header $header = NULL)
    {
    ...
    {
        if ($body instanceof ResetPasswordBody) {
            $this->body = $body;
        }
        return $this;
    }
