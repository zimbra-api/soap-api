...
/**
 * DeleteDataSourceEnvelope class
 * 
 * @package    Zimbra
 * @subpackage Admin
 * @category   Message
 ...
 */
class DeleteDataSourceEnvelope extends Envelope
{
    /**
     * @Accessor(getter="getBody", setter="setBody")
     * @SerializedName("Body")
     * @Type("Zimbra\Admin\Message\DeleteDataSourceBody")
     ...
     * @return self
     */
    public function __construct(Header $header = NULL, DeleteDataSourceBody $body = NULL)
    {
    ...
    {
        if ($body instanceof DeleteDataSourceBody) {
            $this->body = $body;
        }
        return $this;
    }
