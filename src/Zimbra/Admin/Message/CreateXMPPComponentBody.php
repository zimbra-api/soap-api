 ...
 * @XmlRoot(name="Body")
 */
class CreateXMPPComponentBody extends Body
{
    /**
    ...
    /**
     * Constructor method for CreateXMPPComponentBody
     * @return self
     */
    public function __construct(CreateXMPPComponentRequest $request = NULL, CreateXMPPComponentResponse $response = NULL)
    {
