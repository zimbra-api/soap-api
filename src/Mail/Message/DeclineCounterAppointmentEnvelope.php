 ...
 */
class DeclineCounterAppointmentEnvelope extends Envelope
{
    /**
     * @Accessor(getter="getBody", setter="setBody")
     * @SerializedName("Body")
     * @Type("Zimbra\Mail\Message\DeclineCounterAppointmentBody")
     * @XmlElement(namespace="http://www.w3.org/2003/05/soap-envelope")
     */
    private ?BodyInterface $body = NULL;

    /**
     * Constructor method for DeclineCounterAppointmentEnvelope
     *
     * @return self
     */
    public function __construct(?DeclineCounterAppointmentBody $body = NULL, ?Header $header = NULL)
    {
