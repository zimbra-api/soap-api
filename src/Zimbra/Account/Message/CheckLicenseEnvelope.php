 ...
 */
class CheckLicenseEnvelope extends Envelope
{
    /**
     * @Accessor(getter="getBody", setter="setBody")
     * @SerializedName("Body")
     * @Type("Zimbra\Account\Message\CheckLicenseBody")
     * @XmlElement(namespace="http://www.w3.org/2003/05/soap-envelope")
     */
    private $body;

    /**
     * Constructor method for CheckLicenseEnvelope
     * @return self
     */
    public function __construct(Header $header = NULL, CheckLicenseBody $body = NULL)
    {
    ...
    {
        if ($body instanceof CheckLicenseBody) {
            $this->body = $body;
        }
        return $this;
    }
