 ...
 */
class DeleteSignatureEnvelope extends Envelope
{
    /**
    ...
    /**
     * Constructor method for DeleteSignatureEnvelope
     *
     * @return self
     */
    public function __construct(?DeleteSignatureBody $body = NULL, ?Header $header = NULL)
    {
