...
class GetAllAlwaysOnClustersBody extends SoapBody
{
    ...
    #[Type(GetAllAlwaysOnClustersRequest::class)]
    ...
    #[Type(GetAllAlwaysOnClustersResponse::class)]
    #[XmlElement(namespace: "urn:zimbraAdmin")]
    ...
    public function __construct(
        ?GetAllAlwaysOnClustersRequest $request = null,
        ?GetAllAlwaysOnClustersResponse $response = null
    ) {
