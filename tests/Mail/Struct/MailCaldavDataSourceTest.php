...
EOT;
        ...
        $this->assertEquals($caldav, $this->serializer->deserialize($xml, MailCaldavDataSource::class, 'xml'));
        ...
        $this->assertEquals($caldav, $this->serializer->deserialize($json, MailCaldavDataSource::class, 'json'));
    }
}
