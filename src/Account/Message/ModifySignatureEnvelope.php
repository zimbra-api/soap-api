 ...
 */
class ModifySignatureEnvelope extends Envelope
{
    /**
     * @Accessor(getter="getBody", setter="setBody")
     * @SerializedName("Body")
     * @Type("Zimbra\Account\Message\ModifySignatureBody")
     * @XmlElement(namespace="http://www.w3.org/2003/05/soap-envelope")
     */
    private ?BodyInterface $body = NULL;

    /**
     * Constructor method for ModifySignatureEnvelope
     *
     * @return self
     */
    public function __construct(?ModifySignatureBody $body = NULL, ?Header $header = NULL)
    {
