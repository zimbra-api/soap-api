 ...
 */
class AdminCreateWaitSetBody extends SoapBody
{
    /**
     * Soap request
     *
     ...
     * Constructor
     *
     * @param AdminCreateWaitSetRequest $request
     * @param AdminCreateWaitSetResponse $response
     * @return self
     */
    public function __construct(
        ?AdminCreateWaitSetRequest $request = null,
        ?AdminCreateWaitSetResponse $response = null
    ) {
