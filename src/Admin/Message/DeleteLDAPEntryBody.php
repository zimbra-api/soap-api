 ...
 */
class DeleteLDAPEntryBody extends Body
{
    /**
    ...
    /**
     * Constructor method for DeleteLDAPEntryBody
     *
     * @return self
     */
    public function __construct(?DeleteLDAPEntryRequest $request = NULL, ?DeleteLDAPEntryResponse $response = NULL)
    {
