...
class CheckBlobConsistencyBody extends SoapBody
{
     ...
     * Constructor
     *
     * @param CheckBlobConsistencyRequest $request
     * @param CheckBlobConsistencyResponse $response
     * @return self
     */
    ...
    {
        if ($request instanceof CheckBlobConsistencyRequest) {
    ...
    {
        if ($response instanceof CheckBlobConsistencyResponse) {
