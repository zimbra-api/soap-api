...
EOT;
        ...
        $this->assertEquals($cal, $this->serializer->deserialize($xml, MailCalDataSource::class, 'xml'));
        ...
        $this->assertEquals($cal, $this->serializer->deserialize($json, MailCalDataSource::class, 'json'));
    }
}
