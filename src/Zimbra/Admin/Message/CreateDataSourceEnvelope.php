 ...
 */
class CreateDataSourceEnvelope extends Envelope
{
    /**
     * @Accessor(getter="getBody", setter="setBody")
     * @SerializedName("Body")
     * @Type("Zimbra\Admin\Message\CreateDataSourceBody")
     ...
     * @return self
     */
    public function __construct(Header $header = NULL, CreateDataSourceBody $body = NULL)
    {
