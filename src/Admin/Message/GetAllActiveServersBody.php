 ...
 */
class GetAllActiveServersBody extends SoapBody
{
    /**
     * Soap request
     *
     ...
     * Constructor
     *
     * @param GetAllActiveServersRequest $request
     * @param GetAllActiveServersResponse $response
     * @return self
     */
    public function __construct(
        ?GetAllActiveServersRequest $request = null,
        ?GetAllActiveServersResponse $response = null
    ) {
