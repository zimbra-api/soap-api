...
class EnableSharedReminderBody extends SoapBody
{
    ...
    #[SerializedName(name: 'EnableSharedReminderRequest')]
    #[Type(name: EnableSharedReminderRequest::class)]
     ...
     * Constructor
     *
     * @param  EnableSharedReminderRequest $request
     * @param  EnableSharedReminderResponse $response
     * @return self
     */
