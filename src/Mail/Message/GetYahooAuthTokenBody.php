...
class GetYahooAuthTokenBody extends SoapBody
{
     ...
     * Constructor
     *
     * @param  GetYahooAuthTokenRequest $request
     * @param  GetYahooAuthTokenResponse $response
     * @return self
     */
    public function __construct(
        ?GetYahooAuthTokenRequest $request = null,
        ?GetYahooAuthTokenResponse $response = null
    ) {
