 ...
 */
class AutoCompleteGalEnvelope extends Envelope
{
    /**
     * @Accessor(getter="getBody", setter="setBody")
     * @SerializedName("Body")
     * @Type("Zimbra\Admin\Message\AutoCompleteGalBody")
     ...
     * @return self
     */
    public function __construct(Header $header = NULL, AutoCompleteGalBody $body = NULL)
    {
    ...
    {
        if ($body instanceof AutoCompleteGalBody) {
            $this->body = $body;
        }
        return $this;
    }
