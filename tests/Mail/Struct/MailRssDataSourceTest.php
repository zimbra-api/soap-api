 ...
 */
class MailRssDataSourceTest extends ZimbraTestCase
{
    public function testMailRssDataSource()
    {
        ...
        $this->assertTrue($rss instanceof MailDataSource);
...
EOT;
        ...
        $this->assertEquals($rss, $this->serializer->deserialize($xml, StubMailRssDataSource::class, 'xml'));
    }
}
 ...
 */
#[XmlNamespace(uri: 'urn:zimbraMail', prefix: "urn")]
class StubMailRssDataSource extends MailRssDataSource
{
}
