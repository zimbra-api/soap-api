 ...
 */
class SyncGalEnvelope extends Envelope
{
    /**
     * @Accessor(getter="getBody", setter="setBody")
     * @SerializedName("Body")
     * @Type("Zimbra\Account\Message\SyncGalBody")
     * @XmlElement(namespace="http://www.w3.org/2003/05/soap-envelope")
     */
    private $body;

    /**
     * Constructor method for SyncGalEnvelope
     *
     * @return self
     */
    public function __construct(?SyncGalBody $body = NULL, ?Header $header = NULL)
    {
    ...
    {
        if ($body instanceof SyncGalBody) {
            $this->body = $body;
        }
        return $this;
    }
